...
public class ProductTemplateLoaderToDatabase extends AsyncTaskLoader<Boolean> {
    ...
    public ProductTemplateLoaderToDatabase(Context context, String url, String databaseName, int userId, String password, Object[] filter) {
        super(context);
        mUrl = url;
    ...
    protected void onStartLoading() {
        if (!mFinishFlag && !mStartFlag) {
            ...
            db.delete(Contract.ProductEntry.TABLE_NAME, null, null);
            forceLoad();
            mStartFlag = true;
        } else if (mFinishFlag) {
    ...
    public Boolean loadInBackground() {
        ...
        return QueryUtilsProductTemplateOffline.fetchProductTemplateListFromServer(mUrl, mDatabaseName, mUserId, mPassword, mFilter, mDbHelper);
    }

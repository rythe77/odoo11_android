...
public class StockPickingLoader extends AsyncTaskLoader<List<StockPicking>> {
     ...
     */
    public StockPickingLoader(Context context, String url, String databaseName, int userId, String password, Object[] filter) {
        super(context);
        mUrl = url;
     ...
     */
    @Override
    public List<StockPicking> loadInBackground() {
        if (mUrl == null) {
            return null;
        }

        // Perform the network request, parse the response, and extract a list of earthquakes.
        List<StockPicking> stockPickings = QueryUtilsStockPicking.searchReadStockPickingList(mUrl, mDatabaseName, mUserId, mPassword, mFilter, QueryUtils.LIMIT_PAGING_SIZE, 0);
